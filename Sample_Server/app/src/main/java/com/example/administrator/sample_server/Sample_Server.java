package com.example.administrator.sample_server;
...
public class Sample_Server extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sample__server);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    socket = new Socket("149.129.123.49", 10010);
    ...
    private class MyHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.what == 1) {
                ...
                LinearLayoutManager manager = new LinearLayoutManager(Sample_Server.this, LinearLayoutManager.VERTICAL, false);
